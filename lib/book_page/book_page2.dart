...
import 'package:bookapp/book_page/book_page3.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            "◉Atom odatlarining birinchi qonuni buni aniq qilishdir.Ya'ni, siz o'zingiz xohlagan xatti-harakatni ko'rsatishingiz kerak. Ishora qanchalik aniq bo'lsa, buni qilishni eslab qolish ehtimoli shunchalik yuqori bo'ladi.",
              ...
              Row(
                children: [
                  IconButton(
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (contex) => Book1()));
                    },
                  ...
                  IconButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (contex) => Book3()));
                      },
